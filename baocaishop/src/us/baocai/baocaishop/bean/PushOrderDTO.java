...
public class PushOrderDTO {
    ...
    private List<PushOrderDetailDTO> details = new ArrayList<PushOrderDetailDTO>();
    ...
    public List<PushOrderDetailDTO> getDetails() {
        return details;
    }

    public void setDetails(List<PushOrderDetailDTO> details) {
